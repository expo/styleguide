    ...
    colors: {
      ...
      button: {
        primary: {
          ...
          destructive: {
            background:
              'var(--expo-theme-button-primary-destructive-background)',
        ...
        secondary: {
          ...
          disabled: {
            background:
              'var(--expo-theme-button-secondary-disabled-background)',
            border: 'var(--expo-theme-button-secondary-disabled-border)',
            text: 'var(--expo-theme-button-secondary-disabled-text)',
          },
          destructive: {
            background:
              'var(--expo-theme-button-secondary-destructive-background)',
        ...
        quaternary: {
          ...
          disabled: {
            background:
              'var(--expo-theme-button-quaternary-disabled-background)',
